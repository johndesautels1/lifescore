...
### Saving Judge Reports (Updated 2026-02-13)
...
On the Visuals tab, after a Gamma report is generated or loaded from saved reports, you'll see a **Read / Watch Presenter** toggle. This lets you choose how to consume your report:

**Read Mode (Default):** View the full Gamma report in an embedded viewer.

**Watch Presenter Mode:** Olivia presents your report findings as an AI video avatar.
