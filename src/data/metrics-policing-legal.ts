/**
 * LIFE SCORE™ - Policing, Courts & Enforcement Metrics (15 Metrics)
 * Category: policing_legal
 *
...
export const POLICING_LEGAL_METRICS: MetricDefinition[] = [
  {
    ...
    scoringCriteria: { type: 'range', minValue: 50, maxValue: 800 }
  },
  {
    ...
    scoringCriteria: { type: 'range', minValue: 1, maxValue: 5 }
  },
  {
