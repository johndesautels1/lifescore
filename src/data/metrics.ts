 ...
 * Individual category definitions are in metrics-*.ts files.
 */

import type { Category, CategoryId, MetricDefinition } from '../types/metrics';

import { PERSONAL_FREEDOM_METRICS } from './metrics-personal-freedom';
import { HOUSING_PROPERTY_METRICS } from './metrics-housing-property';
import { BUSINESS_WORK_METRICS } from './metrics-business-work';
import { TRANSPORTATION_METRICS } from './metrics-transportation';
import { POLICING_LEGAL_METRICS } from './metrics-policing-legal';
import { SPEECH_LIFESTYLE_METRICS } from './metrics-speech-lifestyle';
