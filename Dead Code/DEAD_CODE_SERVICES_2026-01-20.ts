/**
 * ============================================================================
 * DEAD CODE ARCHIVE - ENHANCED COMPARISON SERVICE & CONTAINER
 * ============================================================================
 *
 * Archived: 2026-01-20
 * Conversation ID: LIFESCORE-2026-0120-CONTINUE
 *
 * This file contains the enhanced comparison service function and container
 * component that were replaced by the LLMSelector + runSingleEvaluatorBatched flow.
 *
 * WHY THIS CODE IS DEAD:
 * - EnhancedComparisonContainer is NEVER imported anywhere
 * - runEnhancedComparison() is only called by EnhancedComparisonContainer
 * - The app now uses LLMSelector component directly with user-selected LLMs
 *
 * TO RESTORE:
 * 1. Copy runEnhancedComparison back to src/services/enhancedComparison.ts
 * 2. Copy EnhancedComparisonContainer back to src/components/EnhancedComparison.tsx
 * 3. Import EnhancedComparisonContainer where needed (e.g., App.tsx)
 *
 * ============================================================================
 */

// ============================================================================
// FROM: src/services/enhancedComparison.ts
// LINES: 82-348 (267 lines)
// INTERFACE + FUNCTION: EnhancedComparisonOptions + runEnhancedComparison
// CALLED BY: EnhancedComparisonContainer (which is never imported)
// ============================================================================
...
// ============================================================================
// FROM: src/components/EnhancedComparison.tsx
// LINES: 1616-1701 (86 lines)
// INTERFACE + COMPONENT + EXPORT: EnhancedComparisonContainerProps +
//   EnhancedComparisonContainer + export default
// CALLED BY: NEVER IMPORTED ANYWHERE
// ============================================================================
...
// ============================================================================
// TYPE STUBS (required for the above code to compile)
// These types/functions were imported in the original files
// ============================================================================

// Placeholder types
type LLMProvider = 'claude-sonnet' | 'gpt-4o' | 'gemini-3-pro' | 'grok-4' | 'perplexity' | 'claude-opus';
type LLMAPIKeys = any;
type EnhancedComparisonProgress = any;
type EnhancedComparisonResult = any;
type CategoryId = any;

// Placeholder imports (React)
declare const React: any;
declare const useState: any;
declare const useEffect: any;

// Placeholder functions
declare function runAllEvaluators(city1: string, city2: string, metrics: any[], apiKeys: any, onProgress?: any): Promise<any>;
declare function runOpusJudge(apiKey: string, params: any): Promise<any>;
declare function buildCategoryConsensuses(consensuses: any[]): any[];
declare function getStoredAPIKeys(): LLMAPIKeys;
declare function updateOGMetaTags(params: any): void;

// Placeholder components
declare const EnhancedProgress: React.FC<any>;
declare const EnhancedResults: React.FC<any>;

// Placeholder constants
declare const ALL_METRICS: any[];
declare const CATEGORIES: any[];
declare const DEFAULT_ENHANCED_LLMS: LLMProvider[];
declare const cache: { getComparison: (key: any) => Promise<any>; setComparison: (key: any, result: any) => Promise<void> };
